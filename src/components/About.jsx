const About = () => {
  return (
    <section
      ...
      <img src="/src/assets/about.svg" alt="about" className="hidden md:block w-64 h-[356px] md:w-[456px]"/>
      <div className="flex-col justify-center">
        ...
        <img src="/src/assets/about.svg" alt="about" width={700} className="md:hidden mb-5"/>
