  ...
  return (
    <header className="bg-[url('/assets/hero.jpg')] bg-center bg-no-repeat bg-cover">
      <div className="pb-10 bg-black bg-opacity-70 flex-col justify-start gap-[162px]">
        <Navbar />
        <div className="font-inter mx-4 sm:mx-14 md:mx-16 lg:mx-[110px] pt-[162px] flex-col justify-center text-white">
          ...
          <p className="text-center font-normal pt-[30px] text-sm lg:text-xl mb-[77px]">
            From grassroots discovery to global impact—where curiosity meets
            expertise, and every learner becomes a builder in both{" "}
            <span className="text-primary">Web2</span> and{" "}
            <span className="text-primary">Web3</span> ecosystems.
          </p>
        </div>
        <div className="flex justify-center items-center">
          <a
            className="text-center cursor-pointer bg-orange px-[32px] py-[16px] text-sm font-[400] text-white mr-[16px]"
            href="#explore"
          >
            Get Started
          </a>
